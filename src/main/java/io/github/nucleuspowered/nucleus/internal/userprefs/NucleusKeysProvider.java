...
public class NucleusKeysProvider implements NucleusUserPreferenceService.Keys {
    ...
    @TargetID(COMMAND_SPY_KEY) @Nullable private PreferenceKey<Boolean> vanishOnLoginKey = null;
    ...
    @TargetID(VANISH_ON_LOGIN_KEY) @Nullable private PreferenceKey<Boolean> commandSpyEnabled = null;
