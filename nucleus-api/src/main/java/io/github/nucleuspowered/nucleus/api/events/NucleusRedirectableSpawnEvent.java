...
/**
 * Called when Nucleus has is about to send a {@link User} to spawn, either now, or on their next login.
 */
@NonnullByDefault
public interface NucleusRedirectableSpawnEvent extends TargetUserEvent, Cancellable {
