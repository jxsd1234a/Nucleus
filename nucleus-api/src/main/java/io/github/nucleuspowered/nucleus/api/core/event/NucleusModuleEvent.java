...
public interface NucleusModuleEvent extends Event {
    ...
    interface AboutToConstruct extends NucleusModuleEvent {
         ...
         */
        void disableModule(String module, PluginContainer plugin) throws UnremovableModuleException, NoModuleException;
    }
    ...
    enum ModuleEnableState {
         ...
         *    {@link NucleusModuleEvent.AboutToConstruct#disableModule(String, PluginContainer)}.
         * </p>
         */
        ENABLED,
